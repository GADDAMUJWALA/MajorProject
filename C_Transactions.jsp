...
.style30 {color: #FF0000; font-size: 16px; }
-->
</style>
</head>
<body>
        ...
        <div class="article style25">
          <h2 class="style26">Transactions !!!</h2>
            ...
            <table width="565" border="2" cellpadding="0" style="border-collapse:collapse" cellspacing="0" align="center">
              <tr>
                <td width="45" height="31" bgcolor="#FFFF00"><div align="center" class="style26 style27"> ID </div></td>
                <td width="117" bgcolor="#FFFF00"><div align="center" class="style30">User Name </div></td>
                <td width="109" bgcolor="#FFFF00"><div align="center" class="style30">File Name </div></td>
                <td width="116" bgcolor="#FFFF00"><div align="center" class="style30">Task</div></td>
                <td width="164" bgcolor="#FFFF00"><div align="center" class="style30">Date &amp; Time</div></td>
              </tr>
              <%
